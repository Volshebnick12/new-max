  ...
  <div class="container header">
    ...
    <div class="nav navigation__down justify-content-between list-down mobile">
      <div class="nav nav-item navigation__down-nav justify-content-around">
        ...
        >
        <router-link class="nav-item list-item-down" to="/about"
          >О нас</router-link
        >
        <router-link class="nav-item list-item-down" to="/news"
          >Новости и акции</router-link
        >
        <router-link class="nav-item list-item-down" to="/map"
          >Как добраться</router-link
        >
      </div>
      <div class="nav nav-item navigation__down-partner justify-content-center">
        <router-link
          class="nav-item list-item-down list-item-color"
          to="/partners"
